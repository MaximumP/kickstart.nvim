  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- ... etc. Spycharm-professional --overwrite '/opt/pycharm-professional/plugins/python-ce/helpers/pydev/*'ee `:help lspconfig-all` for a list of all the pre-configured LSPs
        --
